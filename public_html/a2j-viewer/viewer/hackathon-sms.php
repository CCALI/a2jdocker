...
$client_phone = "7036263287";//$xpath->query("//Answer[@name='Phone TE']/TextValue")->item(0)->nodeValue;
...
$interval =  $next_visit->diff($today);
$meeting_day = $next_visit_date;
...
if (strlen($client_email)){
  ...
  try {
      ...
      $mail->addAddress($client_email, $firstname);     // Add a recipient
